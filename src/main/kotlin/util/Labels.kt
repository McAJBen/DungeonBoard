...
object Labels {
    ...
    const val REMOVE_GRID = "Remove Grid"
    const val SQUARE_WIDTH = "Square Width"
    const val SQUARE_HEIGHT = "Square Height"
    const val LINE_WIDTH = "Line Width"
    const val X_OFFSET = "X Offset"
    const val Y_OFFSET = "Y Offset"
